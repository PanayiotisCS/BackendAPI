...
namespace BackendAPI.Controllers
{
    ...
    public class AnswersController : ControllerBase
    {
        ...
        public AnswersController(BackendContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Answer>> PostAnswer(AnswerDto answerDto)
        {
          if (_context.Answers == null)
          {
              return Problem("Entity set 'BackendContext.Answers'  is null.");
          }
            var answer = new Answer
            {
                Structure = answerDto.Structure,
                FormId = answerDto.FormId,
                UserId = answerDto.UserId,
                DateInserted = answerDto.DateInserted,
            };
